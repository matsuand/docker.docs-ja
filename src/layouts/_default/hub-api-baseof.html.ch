...
@y
  <!-- make the latest API version the canonical page as that's what we want users to be using mostly -->
  <link rel="canonical" href="{{ "__SUBDIR__/reference/api/hub/latest/" | relURL }}" />
@z
...
@y
<body>
  <redoc spec-url="{{ site.BaseURL }}/reference/api/hub/{{ .File.BaseFileName }}.yaml" class="hub-api"></redoc>
  <script src="https://cdn.redoc.ly/redoc/latest/bundles/redoc.standalone.js"></script>
</body>
@z
