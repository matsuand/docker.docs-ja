...
@y
Compose においては組み込み [YAML](https://www.yaml.org/spec/1.2/spec.html#id2765878) 機能を利用して Compose ファイルをより適切かつ効率的に構築することができます。
アンカーやエイリアスを利用すれば、再利用可能なブロックを生成できます。
これは複数のサービスに共通する設定を見出したならば、大変便利に活用できます。
また再利用ブロックを持つことによって、潜在的な記述ミスを減らすこともできます。
@z
