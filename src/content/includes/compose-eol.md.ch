...
>
> 2023 年 7 月より Compose V1 の更新は受信できなくなり、Docker Desktop の新たなリリースには含まれなくなりました。
> 現在は Compose V2 がこれに代わって提供されるようになり、現行のすべての Docker Desktop バージョンに統合されるものとなりました。
> 詳しくは [Compose V2 への移行](__SUBDIR__/compose/migrate) を参照してください。
{ .important }
@z
