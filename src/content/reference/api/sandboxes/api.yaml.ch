...
@x
  ...
  contact:
    name: Docker Cloud Sandboxes
    url: https://github.com/docker/sandboxes-api
servers:
  - url: https://connect.docker.com/sandboxes
    description: The API base URL. Append the /v1 paths while preserving this URL's path prefix.
paths:
  /v1/files:
    get:
      tags:
...
@x
  ...
  /v1/files/content:
    ...
    put:
      ...
      x-sbx-response-schema:
        $ref: "#/components/schemas/FilesWriteFileResponse"
  /v1/files/directories:
    put:
      tags:
        - Files
      summary: Mkdir creates a directory.
      description: |-
...
@x
  ...
  /v1/images:
    get:
      tags:
        - Images
      summary: ListImages lists images in the caller's owner scope.
      description: ListImages lists images in the caller's owner scope.
...
@x
        ...
        - name: filter
          ...
          description: |-
            ...
            name, display_name, uid and status.
          schema:
            type: string
            title: filter
          required: false
...
@x
  ...
  /v1/images/{image}:
    get:
      tags:
        - Images
      summary: GetImage reads one image by its resource name.
      description: GetImage reads one image by its resource name.
      ...
      parameters:
        ...
        - name: If-Match
          ...
          schema:
            ...
            title: If-Match
            description: |-
              etag is the required precondition, the value the target's last read returned.
...
@x
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/mcp-servers/{mcpServer}/authorization:
    get:
      tags:
        - MCP gateways
      summary: GetMcpAuthorization reads the owner-scoped flow, including its pending URL, under mcp.write.
      description: GetMcpAuthorization reads the owner-scoped flow, including its pending URL, under mcp.write.
      operationId: getMcpAuthorization
      parameters:
        - name: mcpServer
          in: path
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/mcp-servers/{mcpServer}/authorization/authorize:
    post:
      tags:
        - MCP gateways
  ...
  /v1/policy-logs:
    get:
      ...
      operationId: listPolicyLogEntriesInOwnerScope
      parameters:
        - name: pageSize
          in: query
          description: |-
...
@x
        ...
        - name: filter
          in: query
          description: |-
            filter is comma-separated exact-match field=value terms; the portable field is
            domain.
          schema:
            type: string
            title: filter
...
@x
  ...
  /v1/sandboxes/{sandbox}:
    get:
      tags:
        - Sandboxes
      summary: GetSandbox reads one sandbox by its resource name.
      description: GetSandbox reads one sandbox by its resource name.
    ...
    delete:
      tags:
        - Sandboxes
      summary: DeleteSandbox returns the deleting resource while work remains, or an empty message when absent.
      description: DeleteSandbox returns the deleting resource while work remains, or an empty message when absent.
      ...
      parameters:
        ...
        - name: force
          in: query
          description: force requests deletion even when the backend would otherwise refuse the state.
          schema:
            type: boolean
            title: force
          required: false
    ...
    patch:
      tags:
        - Sandboxes
      summary: UpdateSandbox changes only the display label under the observed etag.
      description: |-
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/endpoint-credentials:
    post:
      tags:
        - Sandboxes
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/mcp-gateway:
    get:
      tags:
        - MCP gateways
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/mcp-gateway/servers:
    post:
      tags:
        - MCP gateways
  ...
  /v1/sandboxes/{sandbox}/network-policies:
    get:
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/policy-logs:
    get:
      tags:
        - Network policies
      summary: ListPolicyLogEntries lists observed policy decisions.
...
@x
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/ports/{port}:
    get:
      tags:
        - Sandboxes
      summary: GetPort reads one published port by its resource name.
      description: GetPort reads one published port by its resource name.
      operationId: getPort
      parameters:
        - name: sandbox
          in: path
      ...
      responses:
        ...
        "304":
          description: The resource's etag equals the If-None-Match value, so this response carries no body.
        "404":
          description: No publication exists for this port resource name.
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/Error"
              examples:
                notFound:
                  summary: No publication exists for this port resource name.
                  value:
                    code: notFound
    ...
    delete:
      tags:
        - Sandboxes
      summary: DeletePort withdraws one published port.
      description: |-
      ...
      parameters:
        ...
        - name: If-Match
          ...
          schema:
            type: string
            title: If-Match
            description: etag identifies the publication version the caller intends to delete.
      responses:
        "204":
          description: Success. The response carries no body.
        "412":
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/renew-timeout:
    post:
      tags:
        - Sandboxes
...
@x
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/sandboxes/{sandbox}/snapshots:
    post:
      tags:
        - Snapshots
...
@x
      ...
      x-sbx-resource-response:
        $ref: "#/components/schemas/Snapshot"
  /v1/sandboxes/{sandbox}/ssh-certificates:
    post:
      tags:
        - Sandboxes
...
@x
  ...
  /v1/secrets:
    get:
      tags:
        - Secrets
      summary: ListSecrets lists secret metadata in the caller's owner scope.
      description: |-
...
@x
    ...
    post:
      tags:
        - Secrets
      summary: CreateSecret stores new secret material.
      description: |-
...
@x
  ...
  /v1/snapshots/{snapshot}:
    ...
    delete:
      tags:
        - Snapshots
      summary: DeleteSnapshot deletes a snapshot; deleting an already absent snapshot succeeds.
      description: DeleteSnapshot deletes a snapshot; deleting an already absent snapshot succeeds.
...
@x
      ...
      x-sbx-conditional-permissions: []
      x-sbx-authenticated-only: false
  /v1/snapshots/{snapshot}/restore:
    post:
      tags:
        - Snapshots
      summary: RestoreSnapshot forks a new sandbox from a snapshot.
      description: |-
...
@x
    ...
    post:
      tags:
        - Volumes
      summary: CreateVolume creates a persistent volume.
      description: |-
...
@x
    ...
    delete:
      tags:
        - Volumes
      summary: DeleteVolume deletes a volume; deleting an already absent volume succeeds.
      description: |-
...
@x
    ...
    ExchangeCompositionCredentialResponse:
      type: object
...
@x
    ...
    PreconditionFailureErrorDetail:
      type: object
      properties:
        violations:
          type: array
...
@x
  ...
  securitySchemes:
    bearer:
      type: http
      scheme: bearer
      description: A bearer credential is required for every HTTP request. Management operations use an API credential; sandbox endpoint operations use an issued credential scoped to the sandbox, audience and permitted actions.
    sandboxBearer:
      type: http
      scheme: bearer
      description: A short-lived bearer issued by createEndpointCredential for this sandbox, audience and explicit permissions. Management credentials are not accepted.
    sandboxWebSocketBearer:
      type: apiKey
      in: header
      name: Sec-WebSocket-Protocol
      description: Sandbox-scoped credential encoded in the non-echoed subprotocol offer declared by x-websocket. Offer the API subprotocol alongside it; use this carrier only when endpoint discovery advertises webSocketSubprotocol. Never combine it with Authorization.
security:
  - bearer: []
tags:
  - name: Files
    description: Read, write, copy, and manage files inside a sandbox.
    x-displayName: Files
    kind: nav
    summary: Files
  - name: Processes
    description: Run commands and interact with processes inside a sandbox.
    x-displayName: Processes
    kind: nav
    summary: Processes
  - name: Credentials
    description: Exchange credentials for the authenticated owner.
    x-displayName: Credentials
    kind: nav
    summary: Credentials
  - name: Images
    description: Manage images used to create sandboxes.
    x-displayName: Images
    kind: nav
    summary: Images
  - name: MCP gateways
    description: Configure MCP gateways and authorize upstream servers.
    x-displayName: MCP gateways
    kind: nav
    summary: MCP gateways
  - name: Network policies
    description: Read enforced outbound network policies and their decision logs.
    x-displayName: Network policies
    kind: nav
    summary: Network policies
  - name: Sandboxes
    description: Create sandboxes and manage their lifecycle, ports, and SSH access.
    x-displayName: Sandboxes
    kind: nav
    summary: Sandboxes
  - name: Secrets
    description: Store credentials and read their metadata without returning secret material.
    x-displayName: Secrets
    kind: nav
    summary: Secrets
  - name: Snapshots
    description: Capture sandbox state and restore it into a new sandbox.
    x-displayName: Snapshots
    kind: nav
    summary: Snapshots
  - name: Volumes
    description: Manage persistent storage and attach it to sandboxes.
