...
- Docker Desktop において [Kubernetes の有効化](manuals/desktop/features/kubernetes.md#install-and-turn-on-kubernetes) を行っていること。
@z
...
- [Docker Desktop を使った Kubernetes へのデプロイ](manuals/desktop/features/kubernetes.md)
