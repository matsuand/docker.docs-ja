...
@y
keywords: bun, local, development
description: ローカル環境において Bun アプリケーションを開発する方法を学びます。
@z
...
@y
[Bun アプリケーションのコンテナー化](containerize.md) を完了していること。
@z
...
@y
こうしておくことで `server.js` を修正したときには、その変更をリアルタイムで確認できます。
...
@y
このことを確認するため、お好みのテキストエディターを使って `server.js` ファイルを開きます。
