...
@y
Docker Build Cloud を使えば、ローカルマシン上でのビルド作業を簡単にクラウド上に移すことができます。
その際にはビルド時間はより短縮され、特にマルチプラットフォームビルドにおいてそれは顕著なものとなります。
@z

@x
In this demo, you'll see:
@y
このデモを通じて以下を見ていくことにします。
@z
...
@y
- ローカル環境におけるビルダーの設定方法
- Docker Compose を用いた Docker Build Cloud の利用方法
- 開発チームの各メンバーのために、イメージキャッシュがいかにビルドを早めているか
@z
