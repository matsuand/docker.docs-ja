...
@y
この生成 AI (generative AI; GenAI) ガイドでは、Docker を使った既存の GenAI アプリケーションのコンテナー化について学びます。
@z
...
@y
* Python ベースの GenAI アプリケーションをコンテナー化して実行します。
* 完全な GenAI スタックを開発するローカル環境をセットアップします。
@z
