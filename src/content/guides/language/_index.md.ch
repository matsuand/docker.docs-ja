...
@y
* [イメージビルドのベストプラクティス](manuals/build/building/best-practices.md)
* [BuildKit を使ったイメージビルド](manuals/build/buildkit/_index.md#getting-started)
@z
...
@y
        <a href="__SUBDIR__/guides/language/nodejs/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/nodejs.webp" alt="Develop with Node"></a>
@z
@x
        <a href="/guides/language/python/"><img class="m-auto rounded" src="/guides/language/images/python.webp" alt="Develop with Python"></a>
@y
        <a href="__SUBDIR__/guides/language/python/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/python.webp" alt="Develop with Python"></a>
@z
@x
        <a href="/guides/language/r/"><img class="m-auto rounded" src="/guides/language/images/r.webp" alt="Develop with R"></a>
@y
        <a href="__SUBDIR__/guides/language/r/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/r.webp" alt="Develop with R"></a>
@z
@x
        <a href="/guides/language/java/"><img class="m-auto rounded" src="/guides/language/images/java.webp" alt="Develop with Java"></a>
@y
        <a href="__SUBDIR__/guides/language/java/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/java.webp" alt="Develop with Java"></a>
@z
@x
        <a href="/guides/language/golang/"><img class="m-auto rounded" src="/guides/language/images/golang.webp" alt="Develop with Go"></a>
@y
        <a href="__SUBDIR__/guides/language/golang/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/golang.webp" alt="Develop with Go"></a>
@z
@x
        <a href="/guides/language/dotnet/"><img class="m-auto rounded" src="/guides/language/images/c-sharp.webp" alt="Develop with C#"></a>
@y
        <a href="__SUBDIR__/guides/language/dotnet/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/c-sharp.webp" alt="Develop with C#"></a>
@z
@x
        <a href="/guides/language/cpp/"><img class="m-auto rounded" src="/guides/language/images/cpp.webp" alt="Develop with C++"></a>
@y
        <a href="__SUBDIR__/guides/language/cpp/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/cpp.webp" alt="Develop with C++"></a>
@z
@x
        <a href="/guides/language/rust/"><img class="m-auto rounded" src="/guides/language/images/rust-logo.webp" alt="Develop with Rust"></a>
@y
        <a href="__SUBDIR__/guides/language/rust/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/rust-logo.webp" alt="Develop with Rust"></a>
@z
@x
        <a href="/guides/language/php/"><img class="m-auto rounded" src="/guides/language/images/php-logo.webp" alt="Develop with PHP"></a>
@y
        <a href="__SUBDIR__/guides/language/php/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/php-logo.webp" alt="Develop with PHP"></a>
@z
@x
...
@y
        <a href="__SUBDIR__/guides/language/ruby/"><img class="m-auto rounded" src="__SUBDIR__/guides/language/images/ruby-on-rails.webp" alt="Develop with Ruby"></a>
@z
