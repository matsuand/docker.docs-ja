...
@y
- New `buildx history export` command allows exporting the build record into a bundle that can be imported to [Docker Desktop](__SUBDIR__/desktop/). [docker/buildx#3073](https://github.com/docker/buildx/pull/3073)
@z
...
@y
- New command `buildx history import` lets you import build records into Docker Desktop for further debugging in the [Build UI](__SUBDIR__/desktop/use-desktop/builds/). This command requires [Docker Desktop](__SUBDIR__/desktop/) to be installed. [docker/buildx#3039](https://github.com/docker/buildx/pull/3039)
@z
