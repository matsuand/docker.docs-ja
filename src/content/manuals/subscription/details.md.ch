...
Legacy Docker Pro includes:
- Unlimited public repositories
- Unlimited [Scoped Access Tokens](__SUBDIR__/security/for-developers/access-tokens/)
...
@y
There are also advanced collaboration and management tools, including organization and team management with [Role Based Access Control (RBAC)](__SUBDIR__/security/for-admins/roles-and-permissions/), [activity logs](__SUBDIR__/admin/organization/activity-logs/), and more.
@z
...
- [Company layer](__SUBDIR__/admin/company/) to manage multiple organizations and settings
- [Single Sign-On](__SUBDIR__/security/for-admins/single-sign-on/)
- [System for Cross-domain Identity Management](__SUBDIR__/security/for-admins/provisioning/scim/) and more.
@z
