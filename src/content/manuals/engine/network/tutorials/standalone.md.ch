...
@y
Swarm サービスにおいて利用されるのは、一般的には [オーバーレイネットワーク](manuals/engine/network/drivers/overlay.md) です。
このオーバーレイネットワークは、スタンドアロンコンテナーに対しても利用することができます。
このことは [オーバーレイネットワークのチュートリアル](manuals/engine/network/tutorials/overlay.md#use-an-overlay-network-for-standalone-containers) において触れています。
@z
...
@y
- [ホストネットワークのチュートリアル](manuals/engine/network/tutorials/host.md)
- [オーバーレイネットワークのチュートリアル](manuals/engine/network/tutorials/overlay.md)
- [Macvlan ネットワークのチュートリアル](manuals/engine/network/tutorials/macvlan.md)
@z
