...
that sits on top of the read-only, immutable image layers.
@z
...
%たとえば Docker 内部においては、Swarm サービスが`tmpfs`マウントを利用して、サービスコンテナー内に [secrets](manuals/engine/swarm/secrets.md) をマウントしています。
%@z
%
%@x
%### Named pipes
