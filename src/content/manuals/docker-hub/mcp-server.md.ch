...
@y
For more information about MCP concepts and how MCP servers work, see the [Docker MCP Catalog and Toolkit](__SUBDIR__/ai/mcp-catalog-and-toolkit/) overview page.
@z
...
@y
For more details on setting up profiles and connecting clients, see
[Get started with Docker MCP Toolkit](__SUBDIR__/ai/mcp-catalog-and-toolkit/get-started/).
@z
