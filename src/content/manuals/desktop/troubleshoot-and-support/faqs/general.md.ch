...
@x
To run Docker Desktop on Mac without requiring administrator privileges, install via the command line and pass the `â€”user=<userid>` installer flag:
@y
To run Docker Desktop on Mac without requiring administrator privileges, install via the command line and pass the `â€”user=<userid>` installer flag:
@z
...
@x
To run Docker Desktop on Windows without requiring administrator privileges, install via the command line and pass the `â€”always-run-service` installer flag.
@y
To run Docker Desktop on Windows without requiring administrator privileges, install via the command line and pass the `â€”always-run-service` installer flag.
@z
...
@x
```console
$ "Docker Desktop Installer.exe" install â€”always-run-service
```
@y
```console
$ "Docker Desktop Installer.exe" install â€”always-run-service
