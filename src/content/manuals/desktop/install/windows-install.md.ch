...
- Windows 10 64 ビット:
  - Home または Pro 22H2 (ビルド 19045) またはそれ以降を推奨。
    あるいは Enterprise または Education 22H2 (ビルド 19045) またはそれ以降を推奨。
  - 最低でも Home または Pro 21H2 (ビルド 19044) またはそれ以降。
    あるいは Enterprise または Education 21H2 (ビルド 19044) またはそれ以降。
...
- Windows 10 または Windows 11 上の WSL 2 を正常動作させるためには、以下のハードウェア要件が必要。
  ...
  - BIOS におけるハードウェア仮想機能の有効化。
    詳しくは [仮想化](../troubleshoot/topics.md#virtualization) を参照してください。
@z

@x
For more information on setting up WSL 2 with Docker Desktop, see [WSL](../wsl/_index.md).
@y
Docker Desktop を用いる際の WSL 2 の設定に関する詳細は [WSL](../wsl/_index.md) を参照してください。
@z
...
詳しくは [VM または VDI 環境での Docker Desktop の実行](../vm-vdi.md) を参照してください。
@z
...
@y
- ローカルホストから Windows コンテナーに接続する方法を理解するには、[Windows からコンテナーに接続したい](../networking.md#i-want-to-connect-to-a-container-from-the-host) を参照してください。
@z
...
> [!TIP]
>
> 管理者権限がなくても Docker Desktop のインストールと実行を行う方法については [FAQ](manuals/desktop/faqs/general.md#how-do-I-run-docker-desktop-without-administrator-privileges) を参照してください。
@z
...
> また [強制的なサインイン](../../security/for-admins/enforce-sign-in/_index.md) の機能もあります。
> - [Intune](https://learn.microsoft.com/en-us/mem/intune/apps/app-discovered-apps)
> - [Jamf](https://docs.jamf.com/10.25.0/jamf-pro/administrator-guide/Application_Usage.html)
> - [Kandji](https://support.kandji.io/support/solutions/articles/72000559793-view-a-device-application-list)
> - [Kolide](https://www.kolide.com/features/device-inventory/properties/mac-apps)
...
- [Docker Desktop の確認](../use-desktop/_index.md) を行って、その全機能を見てください。
- [トラブルシューティング](manuals/desktop/troubleshoot/_index.md) では、一般的な問題、回避策、サポートの受け方などについて説明しています。
