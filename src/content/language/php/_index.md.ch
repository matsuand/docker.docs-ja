...
@y
言語別ガイド PHP 向けでは、Docker を使ってコンテナー化した PHP アプリケーションの生成方法について説明をはじめます。
...
@y
* PHP アプリケーションをコンテナー化して実行します。
* コンテナーを利用して PHP アプリケーションを開発するローカル環境を構築します。
* コンテナーを使って PHP アプリケーションのテストを実行します。
* GitHub アクションを使って、コンテナー化した PHP アプリケーションの CI/CD パイプラインを設定します。
* コンテナー化した PHP アプリケーションをローカルな Kubernetes にデプロイして、テストおよびデバッグを行います。
@z
...
@y
では手元にある PHP アプリケーションのコンテナー化からはじめます。
@z

@x
{{< button text="Containerize a PHP app" url="containerize.md" >}}
@y
{{< button text="PHP アプリのコンテナー化" url="containerize.md" >}}
@z
