...
@y
{{< button text="RPM パッケージ" url="https://desktop.docker.com/linux/main/amd64/157355/docker-desktop-x86_64.rpm?utm_source=docker&utm_medium=webreferral&utm_campaign=docs-driven-download-linux-amd64" >}}
@z
